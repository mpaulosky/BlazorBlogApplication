...
public class FakeAppUserTests
{
	...
	public void GetNewAppUser_ShouldReturnValidUser()
	{
		...
		Enum.TryParse<Web.Data.Enums.Roles>(user.Roles![0], ignoreCase: true, out _).Should().BeTrue();
	}
	...
	public void GetAppUsers_ShouldReturnRequestedCount()
	{
		...
		foreach (var u in list)
		{
			...
			Enum.TryParse<Web.Data.Enums.Roles>(u.Roles![0], true, out _).Should().BeTrue();
		}
	}
